        ...
        <Drawer.Root direction="right" modal={false} open={isOpen}>
            ...
            <Drawer.Portal>
                ...
                >
                    ...
                    <div className="bg-white h-5/6 w-full grow py-5 flex flex-col rounded-[16px]">
                            ...
                            {chat.map((message, index) => {
                                ...
                                return (
                                    <div key={index} className={`flex flex-col gap-1 px-4  ${ isUser ? "items-end justify-end" : "items-start justify-start" }`}>
                                        ...
                                        <div className={`text-[13px] py-2 px-4 rounded-lg drop-shadow-md max-w-[80%] whitespace-pre-line ${
                                            isUser
