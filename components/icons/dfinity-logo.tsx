...
const DfinityLogo: React.FC<{ className?: string }> = ({ className = '' }) => (
    <div className={`flex items-center gap-2 ${className}`}>
        ...
        >
            ...
            fill="url(#paint0_linear_9598_62140)"
            />
            <path
            ...
            fill="url(#paint1_linear_9598_62140)"
            />
            <defs>
            <linearGradient
                id="paint0_linear_9598_62140"
                x1="31.2622"
                y1="37.3828"
                x2="3.40487"
                y2="8.53484"
        ...
        <div className="grid grid-cols-1 text-xl font-semibold text-[#181818] dark:text-white justify-start -ms-5">
            <span className="col-span-1 ms-5">
                Internet
            </span>
            <span className="col-span-1 ms-4">
                Computer
            </span>
        </div>
  </div>
